...
public class Esteira {
    ...
    * @return Retorna a quantidade possível de pacotes produzidos no intervalo de
    *         tempo.
    */
   ...
   public void empacotarPedidos() {
      ...
      double tempoEmpacotando = qtdDePacote * TEMPO_EMPACOTAMENTO; // TEMPO GASTO PARA EMPACOTAR OS PRODUTOS (Em
                                                                   // segundos)
   }
}
